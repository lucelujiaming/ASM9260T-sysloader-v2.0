...
// /* FAT tables */
// typedef struct blk_fat_part_info {
...
int file_fat_detectfs(block_dev_desc_t * cur_dev);
int file_fat_ls(block_dev_desc_t * cur_dev,const char *dir);
long file_fat_read(block_dev_desc_t * cur_dev,const char *filename, void *buffer, unsigned long maxsize);
const char *file_getfsname(int idx);
int fat_register_device(block_dev_desc_t * cur_dev, int part_no);
int disk_read (block_dev_desc_t * cur_dev, __u32 startblock, __u32 getsize, __u8 * bufptr);
