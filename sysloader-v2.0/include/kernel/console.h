...
typedef struct
{
    AS_REG32        PLLCTRL0[4]  ;  //	0x00	R/W		
    AS_REG32        PLLCTRL1[4]   ;  //	0x10	R/W 
    AS_REG32        CPUCLKCTRL[4]     ;  //	0x20	R/W 
    AS_REG32        HBUSCLKCTRL[4]   ;  //	0x30	R/W 
    AS_REG32        XBUSCLKCTRL[4]   ;  //	0x40	R/W 
    AS_REG32        XTALCLKCTRL[4]   ;  //	0x50	R/W 
    AS_REG32        OCRAMCLKCTRL[4]      ;  //	0x60	R/W 
    AS_REG32        UTMICLKCTRL[4]      ;  //	0x70	R/W	
    AS_REG32        SSPCLKCTRL[4]     ;  //	0x80	R/W
    AS_REG32        GPMICLKCTRL[4]   ;  //	0x90	R/W 
    AS_REG32        SPDIFCLKCTRL[4]      ;  //	0xA0	R/W 
    AS_REG32        EMICLKCTRL[4]      ;  //	0xB0	R/W	
    AS_REG32        NANDCLKCTRL[4]     ;  //	0xC0	R/W
    AS_REG32        CLKCTRL_PLL180[4]     ;  //	0xD0	R/W   LCD
} /*__attribute__((__packed__))*/ AS3310_CLK;


typedef struct
{
    AS_REG32        CTRL0[4]     ;  //	0x00	R/W		
    AS_REG32        COMPARE[4]   ;  //	0x10	R/W 
    AS_REG32        CTRL1[4]     ;  //	0x20	R/W 
    AS_REG32        TIMING0[4]   ;  //	0x30	R/W 
    AS_REG32        TIMING1[4]   ;  //	0x40	R/W 
    AS_REG32        TIMING2[4]   ;  //	0x50	R/W 
    AS_REG32        DATA[4]      ;  //	0x60	R/W 
    AS_REG32        STAT[4]      ;  //	0x70	R	
    AS_REG32        DEBUG[4]     ;  //	0x80	R
...
{
    AS_REG32        CTRL0[4]   ;          //	0x00	R/W		
    AS_REG32        CTRL1[4]  ;           //	0x10	R/W 
    AS_REG32        CTRL2[4]     ;         //	0x20	R/W 
    AS_REG32        LINE_CTRL[4]  ;          //	0x30	R/W 
    AS_REG32        INTR[4]   ;       //	0x40	R/W 
    AS_REG32        DATA[4]   ;        //	0x50	R/W 
    AS_REG32        SATA[4] ;  //	0x60	R/W 
    AS_REG32        DEBUG[4] ;  //	0x70	R/W	
} /*__attribute__((__packed__))*/ ALP_UART5;

typedef struct
{
    AS_REG32    SPCR        ;       //	0x80000180		//	R/W	0x10	Control register
    AS_REG32    SPSR        ;       //	0x80000184		//	R	0x00	Status register 
    AS_REG32    SPER        ;       //	0x80000188		//	R/W	0x00	Extensions Register
    AS_REG32    RE_REG  ;       //	0x8000018c	//	R	0x00	Receive register
    AS_REG32    TR_REG  ;       //	0x80000190	//	W	0x00	Transmitter register
...
typedef struct
{
    ...
    AS_REG32    DATA[4]        ;   
    AS_REG32    DEBUG0[4]      ;   
    AS_REG32    DEBUG1[4]      ;   // 0x70
} /*__attribute__((__packed__))*/ AS3310_I2C;

typedef struct
{
    AS_REG32        USB_PHY_PWD[4]   ;          //	0x00	R/W		
    AS_REG32        USB_PHY_TX[4]   ;           //	0x10	R/W 
    AS_REG32        USB_PHY_RX[4]     ;         //	0x20	R/W 
    AS_REG32        USB_PHY_CTRL[4]  ;          //	0x30	R/W 
    AS_REG32        USB_PHY_STATUS[4]   ;       //	0x40	R/W 
    AS_REG32        USB_PHY_DEBUG[4]   ;        //	0x50	R/W 
    AS_REG32        USB_PHY_DEBUG0_STATUS[4] ;  //	0x60	R/W 
    AS_REG32        USB_PHY_DEBUG1_STATUS[4] ;  //	0x70	R/W	
    AS_REG32        USB_PHY_DEBUG2_STATUS[4] ;  //	0x80	R/W
    AS_REG32        USB_PHY_SYS_CTRL[4]   ;     //	0x90	R/W 
    AS_REG32        USB_PHY_ANALOG[4]      ;    //	0xA0	R/W 
} /*__attribute__((__packed__))*/ AS3310_USB_PHY_CTRL;

typedef volatile struct _mentor_reg_
{
    AS_REG8         R_FAddr       ;        //(0x00 + USB_BaseAddr))
    AS_REG8         R_Power       ;        //(0x01 + USB_BaseAddr))
    AS_REG16        R_IntrTx      ;        //)(0x02 + USB_BaseAddr)
    AS_REG16        R_IntrRx      ;        //)(0x04 + USB_BaseAddr)
    AS_REG16        R_IntrTxE     ;        //)(0x06 + USB_BaseAddr)
    AS_REG16        R_IntrRxE     ;        //)(0x08 + USB_BaseAddr)
    AS_REG8         R_IntrUSB     ;        //(0x0A + USB_BaseAddr))
    AS_REG8         R_IntrUSBE    ;        //(0x0B + USB_BaseAddr))
    AS_REG16         R_Frame       ;        //(0x0C + USB_BaseAddr))
    AS_REG8         R_Index       ;        //(0x0E + USB_BaseAddr))
    AS_REG8         R_Testmode    ;        //(0x0F + USB_BaseAddr))

    AS_REG16        R_TxMaxP      ;           //  0x10 + USB_BaseAddr))      
    AS_REG16        R_TxCSR       ;           //  0x12 + USB_BaseAddr)) 
    AS_REG16        R_RxMaxP      ;         //  0x14 + USB_BaseAddr))  
    AS_REG16        R_RxCSR       ;          //  0x16 + USB_BaseAddr))  
    AS_REG16        R_RxCount     ;         //  0x18 + USB_BaseAddr))
    AS_REG8         R_rsvd[5]     ;          //
    AS_REG8         R_ConfigData  ;     //    0x1F + USB_BaseAddr))   

    AS_REG32        R_FIFO0     ;     //   (0x20 + USB_BaseAddr)                              
    AS_REG32        R_FIFO1      ;     //   (0x24 + USB_BaseAddr)                          
    AS_REG32        R_FIFO2      ;     //   (0x28 + USB_BaseAddr) 
    AS_REG32        R_FIFO3      ;     //   (0x2C + USB_BaseAddr)                          
    AS_REG32        R_FIFO4      ;     //   (0x30 + USB_BaseAddr)                          
    AS_REG32        R_FIFO5      ;     //   (0x34 + USB_BaseAddr)                          
    AS_REG32        R_FIFO6      ;     //   (0x38 + USB_BaseAddr)                          
    AS_REG32        R_FIFO7      ;     //   (0x3C + USB_BaseAddr)                          
    AS_REG32        R_FIFO8      ;     //   (0x40 + USB_BaseAddr)                          
    AS_REG32        R_FIFO9      ;     //   (0x44 + USB_BaseAddr)                          
    AS_REG32        R_FIFO10     ;     //   (0x48 + USB_BaseAddr)                          
    AS_REG32        R_FIFO11     ;     //   (0x4C + USB_BaseAddr)                          
    AS_REG32        R_FIFO12     ;     //   (0x50 + USB_BaseAddr)                          
    AS_REG32        R_FIFO13     ;     //   (0x54 + USB_BaseAddr)                          
    AS_REG32        R_FIFO14     ;     //   (0x58 + USB_BaseAddr)                          
    AS_REG32        R_FIFO15     ;     //   (0x5C + USB_BaseAddr)                          

    AS_REG16         R_DevCtl                ;   //   0x60 + USB_BaseAddr)) 
    AS_REG8          R_TxFIFOsz             ;   //   0x62 + USB_BaseAddr))  
    AS_REG8          R_RxFIFOsz            ;   //   0x63 + USB_BaseAddr))  
    AS_REG16         R_TxFIFOadd           ;   //   0x64 + USB_BaseAddr)) 
    AS_REG16         R_RxFIFOadd           ;   //   0x66 + USB_BaseAddr)) 
    AS_REG32         R_VControl_VStatus    ;   //   0x68 + USB_BaseAddr))   
    AS_REG16         R_HWVers              ;   //   0x6C + USB_BaseAddr)) 
    AS_REG8          rsvd2[10]             ;                          // 
    AS_REG8          R_EPInfo              ;   //   0x78 + USB_BaseAddr))  
    AS_REG8          R_RAMInfo             ;   //   0x79 + USB_BaseAddr))  
    AS_REG8          R_LinkInfo            ;   //   0x7A + USB_BaseAddr))  
    AS_REG8          R_VPLen               ;   //   0x7B + USB_BaseAddr))  
    AS_REG8          R_HS_EOF1             ;   //   0x7C + USB_BaseAddr))  
    AS_REG8          R_FS_EOF1             ;   //   0x7D + USB_BaseAddr))  
    AS_REG8          R_LS_EOF1             ;   //   0x7E + USB_BaseAddr))  

}/*__attribute__((__packed__))*/ AS3310_USB_CTRL;



typedef volatile struct _usb_dma_channel_
{
    AS_REG32     USB_CH_INTR;
    AS_REG32     USB_CH_CNTL;
    AS_REG32     USB_CH_ADDR;
    AS_REG32     USB_CH_COUNT;
}USB_DMA_CH;


typedef volatile struct _usb_dma_reg_
{
    USB_DMA_CH     USB_CH[16];
}USB_DMA_CTRL;


typedef  volatile struct _usb_csrep_reg_
{
    AS_REG16        R_TxMaxP      ;          //  0x0   
    AS_REG16        R_TxCSR       ;          //  0x2
    AS_REG16        R_RxMaxP      ;          //  0x4 
    AS_REG16        R_RxCSR       ;          //  0x6 
    AS_REG16        R_RxCount     ;          //  0x8 
    AS_REG8         R_TxType     ;           //
    AS_REG8         R_TxIntval     ;           //
    AS_REG8         R_RxType     ;           //
    AS_REG8         R_RxIntval     ;           //
    AS_REG8         R_rsvd     ;           //
    AS_REG8         R_FIFOSize  ;     //    0xF
}  USB_CSR_EP;


typedef volatile struct _usb_ex_ep_reg_
{
    USB_CSR_EP      CSR_EP[5];
} USB_CSREP;
...
#define HW_LCDIF_TIMING        0x80084010
#define HW_LCDIF_DATA       0x80084020
#define HW_LCDIF_DEBUG         0x80084030
...
/*USB0 PHY*/
#define USBPHY0_BaseAddr        0x80098000 //USB0 PHY base address
