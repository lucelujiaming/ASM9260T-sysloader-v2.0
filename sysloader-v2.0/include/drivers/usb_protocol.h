...
//
//	File name: USB100.h
//	  USB 1.00 Version Header Definition.
//
//	Revision history
//
//		2004.10.16	ZhuoYongHong begin
//
//****************************************************************************
...
#define USB_VENDOR_ID   0xA133
#define USB_PRODUCT_ID  0xC001
...
#define USB_ENDPOINT_DIRECTION_MASK               (unsigned char)0x80
#define USB_TRANSMIT_INDEX                    0x80
#define USB_RECEIVE_INDEX                     0x00
...
typedef struct _USB_LANGID_DESCRIPTOR {
	UCHAR				bLength;
	UCHAR				bDescriptorType;
	USHORT			wLANGID[1];
} __attribute__((packed)) USB_LANGID_DESCRIPTOR, *PUSB_LANGID_DESCRIPTOR;
...
/* mass storage device definition */
#define USB_CLASS_CODE_TEST_CLASS_DEVICE		0x08
#define USB_SUBCLASS_CODE_RBC_CLASS				0x01  /*Reduced Block Commands (RBC)*/
#define USB_PROTOCOL_CODE_BULKONLY_CLASS		0x50	/*Bulk-Only Transport*/

#define USB_MS_DEVICE								1			/* mass-storage interface device */
#define USB_EDICT_DEVICE							2			/* edict device */
