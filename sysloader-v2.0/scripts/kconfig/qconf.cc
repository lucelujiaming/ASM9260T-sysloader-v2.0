...
{
	static char str[] = "Welcome to the qconf graphical SramLoader configuration tool for Linux.\n\n"
...
void ConfigMainWindow::showAbout(void)
{
	static char str[] = "qconf is Copyright (C) 2002 Roman Zippel <zippel@linux-m68k.org>.\n\n"
		"Bug reports and feature request can also be entered at http://bugs.SramLoader.net/\n";
